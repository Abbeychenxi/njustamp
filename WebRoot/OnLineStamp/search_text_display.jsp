    ...
    <div class="col-lg-12">
        ...
        <div class="row" style="margin-left:-20px;">
            <c:forEach var="newStamp" items="${newStamps }" varStatus="status">
               <div class="col-lg-2"  style="width: 150px;height: 170px"   > <a class="thumbnail fancybox" rel="ligthbox" href="album_look.html"> <img class="img-responsive" style="width: 150px;height: 130px;" alt="" src="DisplayTestStamp?id=${status.index }" />
