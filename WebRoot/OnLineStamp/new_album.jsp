    	...
    	<div class="row" style="margin-left:-20px;">
        	<div class="col-lg-12" style="margin-top:-70px; ">
            	<ul class="list-inline">
                	<li class="span text-left text-primary"><h2>最新邮册</h2></li>
                    <li class="text text-info" style="margin-left:30px;"><a href="/nihao/AlbumServlet?label=album">邮册</a></li>
                    <li class="text text-info" style="margin-left:20px;"><a href="/nihao/AlbumServlet?label=collect">最近收藏</a></li>
