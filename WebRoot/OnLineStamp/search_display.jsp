    ...
    <div class="col-lg-12">
    	<div class="row" style="margin-left:-20px;">
        	<div class="col-lg-12" style="margin-top:-70px; ">
            	<ul class="list-inline">
                    ...
                    <li class="text text-info" style="margin-left:30px;"><a href="/nihao/SearchServlet?search=county&county=${title }">${title }</a></li>
                     </c:forEach>
                </ul>
            </div>
        </div><!-- /.row -->
        <div class="row" style="margin-left:-20px;">
            <c:forEach var="newStamp" items="${newStamps }" varStatus="status">
               <div class="col-lg-2"  style="width: 150px;height: 170px"   > <a class="thumbnail fancybox" rel="ligthbox" href="album_look.html"> <img class="img-responsive" style="width: 150px;height: 130px;" alt=""src="ImageDisplayServelt?id=${status.index }" />
