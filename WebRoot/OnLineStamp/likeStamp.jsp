...
<div class="container">
    <div class="col-lg-12">
    	<div class="row" style="margin-left:-20px;">
        	<div class="col-lg-12" style="margin-top:-70px; ">
            	<ul class="list-inline">
                	<li class="span text-left text-primary"><h2>测你喜欢</h2></li>
                    <li class="text text-info" style="margin-left:30px;"><a href="/nihao/HotStampServlet">热门邮票</a></li>
        ...
        <div class="row" style="margin-left:-20px;">
            <c:forEach var="hotStamp" items="${likeStamps }" varStatus="status">
               <div class="col-lg-2" style="width: 180px;height: 200px"> <a class="thumbnail fancybox" rel="ligthbox" href="album_look.html"> <img class="img-responsive" style="width: 180px;height: 180px;" alt="" src="DisplayHomeServelt?id=${status.index }&label=likeMore" />
