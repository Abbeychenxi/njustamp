    ...
    <div class="col-lg-12">
    	<div class="row" style="margin-left:-20px;">
        	<div class="col-lg-12" style="margin-top:-70px; ">
            	<ul class="list-inline">
                	<li class="span text-left text-primary"><h2>最新邮票</h2></li>
                    <li class="text text-info" style="margin-left:30px;"><a href="/nihao/GuessYouLikeServlet">测你喜欢</a></li>
                    <li class="text text-info" style="margin-left:20px;"><a href="/nihao/HotStampServlet">热门邮票 </a></li>
        ...
        <div class="row" style="margin-left:-20px;">
            <c:forEach var="newStamp" items="${newStamps }" varStatus="status"> 
               <div class="col-lg-2" style="width: 180px;height: 200px"> <a class="thumbnail fancybox" rel="ligthbox" href="album_look.html"> <img class="img-responsive" style="width: 180px;height: 180px;" alt="" src="DisplayHomeServelt?id=${status.index }&label=newMore" />
